...
// Récupération du score depuis les paramètres de l'URL
  ...
  .then((data) => {
    ...
    if (scoreValue) {
      if (scoreValue / quizSize >= 0.8) {
        // Réponse en fonction du socre du joueur. Animation différente en fonction du pourcentage de bonne réponses
...
// Redirection vers la page d'accueil lorsque le bouton est cliqué
